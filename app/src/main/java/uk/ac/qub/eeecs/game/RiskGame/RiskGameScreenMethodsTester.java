...
public class RiskGameScreenMethodsTester {
    ...
    public PushButton mAttackButton;
    public Bitmap mRiskGameScreenBackground;
    public Bitmap mRiskMapAreas;
    public GameObject mRiskMap;
